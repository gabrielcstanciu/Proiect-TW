...
<div class="form-group">
              <label class="control-label" style="color:red">Gender: </label>
              <?php  if($row['Gender']=="Female"){ ?>
              <input type="radio" name="gender" id="gender" value="Female" checked="true" style="color:red">Female
              <input type="radio" name="gender" id="gender" value="male" style="color:red">Male
              <?php } else { ?>
              <label>
              <input type="radio" name="gender" id="gender" value="Male" checked="true" style="color:red">Male
              <input type="radio" name="gender" id="gender" value="Female" style="color:red">Female
              </label>
             <?php } ?>
            </div>
<div class="form-group">
...
<?php } ?>
<button type="submit" name="submit" id="submit" class="btn btn-o btn-primary" style="color:red">
Update
</button>
</form>
</div>
